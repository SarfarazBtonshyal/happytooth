...
export default function ClinicCard({
  ...
  return (
    <div className="bg-[#FAF7F2] rounded-[2.5rem] border border-border-gray border-t-4 border-t-accent-teal shadow-[0_8px_30px_rgb(0,0,0,0.02)] overflow-hidden flex flex-col justify-between hover:shadow-[0_20px_50px_rgba(172,146,102,0.18)] hover:border-accent-teal/40 hover:-translate-y-1.5 transition-all duration-500 ease-out">
      ...
      <div className="p-8 md:p-10 pt-0 flex flex-col sm:flex-row gap-4 bg-transparent">
        <a
          href={waLink}
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 text-center border border-navy-blue/70 text-navy-blue hover:bg-[#25D366] hover:border-[#25D366] hover:text-white font-bold text-xs uppercase tracking-[0.18em] py-4 rounded-full transition-all duration-300 flex items-center justify-center gap-2"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 text-center bg-navy-blue border border-navy-blue text-[#FAF7F2] hover:bg-accent-teal hover:border-accent-teal hover:text-navy-blue font-bold text-xs uppercase tracking-[0.18em] py-4 rounded-full transition-all duration-300 shadow-md flex items-center justify-center gap-2"
        >
