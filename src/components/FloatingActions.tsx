...
export default function FloatingActions() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] px-4 py-3 lg:hidden flex flex-col gap-2.5">
      {/* Clinic 1: Murukkumpuzha */}
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          className="bg-[#25D366] hover:bg-[#20ba59] text-white font-bold px-4 py-3 rounded-xl flex items-center justify-center gap-1.5 text-xs shadow-sm transition active:scale-95 duration-200"
        >
          <svg
